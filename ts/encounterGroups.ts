const mineEncounterGroups =  Object.freeze({
    "Mine_Room_Small": {
        ...
        "secret":[
            ...
            //{"weight":10, "name": "Mine_Small_Secret_DogShadow", "requirements":"delve_count>5, dog_shadow_found == 0"},
        ...
        "hidden": [
			...
			//{"weight":1, "name": "Mine_Small_Hidden_RatFriendship", "requirements":"NotDiscovered == 0"},
			{"weight":3, "name": "Mine_Small_Hidden_Chest", "requirements":""},
    ...
    "Mine_Room_Large": {
        ...
        "treasure_encounters":[
            ...
            //{"weight":5, "name": "Mine_Large_Treasure_SecretShop", "requirements":"peasant2_unlocked > 0, dibble_upgrade_count < 4"},
