        ...
        small: {
            ...
            normal: {
                rooms: [
                    ...
                    { weight: 3, name: "EWSpinners", noExit: 6 },
                    ...
                    { weight: 2, name: "HoleEW", noExit: 6 },
                    { weight: 2, name: "HoleEWSpinner", noExit: 6 },
                    { weight: 4, name: "Plain" },
        ...
        large: {
            normal: {
                rooms: [
                    ...
                    { weight: 3, name: "CornerNE", noExit: 14 },
                    { weight: 1, name: "LandBridgeNS", noExit: 12 },
                    { weight: 2, name: "DualPillars" },
                    { weight: 2, name: "SpikeBridge", noExit: 6 },
                    { weight: 3, name: "CornerSW", noExit: 5 },
                    ...
                    { weight: 2, name: "ArenaTrack", noExit: 12 },
                    { weight: 2, name: "QuadPillars" },
                    { weight: 2, name: "RockArrowMaze" },
                    { weight: 2, name: "RailGuantlet", noExit: 6 },
                    { weight: 2, name: "HazardHeavy" },
                    { weight: 2, name: "ArrowGuantlet" },
                    { weight: 2, name: "DonutSpinner", noExit: 6 },
            ...
            treasure: {
                rooms: [
                    ...
                    { weight: 3, name: "HoleSpikeChest", noExit: 4 },
        ...
        small: {
            ...
            normal: {
                rooms: [
                    ...
                    { weight: 3, name: "Pillars", noExit: 12 },
                    { weight: 3, name: "Water" },
                    { weight: 3, name: "Torches" },
                    { weight: 3, name: "DynamicPillar" },
                    { weight: 1, name: "ArrowBridge", noExit: 6 },
                    { weight: 1, name: "FlamingArrows", noExit: 12 },
                    { weight: 3, name: "TallBlocks" },
                    { weight: 1, name: "SetPiece" },
                    { weight: 2, name: "Track" },
                    { weight: 3, name: "Empty" },
                    { weight: 3, name: "SmallBowTie", noExit: 6 },
                    { weight: 3, name: "RazorBlade", noExit: 12 },
                    { weight: 2, name: "VerticalHole", noExit: 6 },
                ]
            },
            special: {
                rooms: [
        ...
        large: {
            normal: {
                rooms: [
                    ...
                    { weight: 3, name: "BridgeEW", noExit: 6 },
                    { weight: 3, name: "BridgeNS", noExit: 12 },
                    { weight: 2, name: "BendNE", noExit: 14 },
                    { weight: 1, name: "BendNEPillar", noExit: 14 },
                    { weight: 2, name: "BendSW", noExit: 5 },
                    { weight: 1, name: "BendSWPillar", noExit: 5 },
                    { weight: 3, name: "BallChainDynamic" },
                    { weight: 3, name: "BallChain" },
                    { weight: 3, name: "HolesBlocks" },
                    { weight: 3, name: "DynamicShape" },
                    { weight: 3, name: "Cells" },
                    { weight: 1, name: "Guantlet", noExit: 6 },
                    ...
                    { weight: 2, name: "SpikeStrip", noExit: 6 },
                    { weight: 3, name: "Cross" },
                    { weight: 3, name: "Ess", noExit: 6 },
                    ...
                    { weight: 1, name: "SewerPart2", noExit: 6 },
                    { weight: 3, name: "SewerPart3" },
                    { weight: 2, name: "SewerPart4" },
                    { weight: 1, name: "VerticalHall", noExit: 12 },
                    { weight: 3, name: "CornerPillar" },
                    { weight: 3, name: "OffsetTurrets" },
                    { weight: 2, name: "MorningStarBridge", noExit: 1 },
                ]
            },
            treasure: {
                rooms: [
        ...
        large: {
            normal: {
                rooms: [
                    ...
                    { weight: 2, name: "BendSW", direction: 5 },
                    { weight: 1, name: "BendSWPillar", direction: 5 },
                    { weight: 2, name: "BendSE", direction: 7 },
                    { weight: 1, name: "BendSEPillar", direction: 7 },
                    { weight: 2, name: "BendNW", direction: 11 },
                    { weight: 1, name: "BendNWPillar", direction: 11 },
                    { weight: 1, name: "BendNEPillar", direction: 14 },
                    { weight: 2, name: "BendNE", direction: 14 },
                    { weight: 5, name: "Arena" },
                    { weight: 3, name: "DeadlyDonut", direction: 12 },
                    { weight: 2, name: "Knot" },
                    { weight: 2, name: "DonutSpinner", direction: 6 },
                    { weight: 3, name: "HazardHeavy" },
                    { weight: 2, name: "GargoyleHall" },
                    { weight: 2, name: "EWBridgeThin", direction: 6 },
                    { weight: 3, name: "EWBridgeThick", direction: 6 },
                    { weight: 3, name: "SpiderDen" },
                    { weight: 4, name: "ChessBoard" },
                    { weight: 5, name: "CrossHole" },
                    { weight: 2, name: "ArrowFun", direction: 6 },
        ...
        large: {
            normal: {
                rooms: [
                    ...
                    { weight: 3, name: "HallwayEW", noExit: 6 },
                    { weight: 3, name: "HallwayNS", noExit: 12 },
                    { weight: 4, name: "CornerColumns" },
                    { weight: 4, name: "UPillar", noExit: 1 },
                    { weight: 4, name: "VPillar", noExit: 1 },
                    { weight: 4, name: "UPillarReverse", noExit: 3 },
                    { weight: 4, name: "VPillarReverse", noExit: 3 },
                    ...
                    { weight: 3, name: "WestSlant", noExit: 4 },
                    { weight: 3, name: "EastSlant", noExit: 2 },
                    { weight: 4, name: "Razor", noExit: 12 },
                    { weight: 4, name: "BowTie", noExit: 6 },
                    { weight: 2, name: "BendNW", noExit: 11 },
                    { weight: 2, name: "BendNE", noExit: 12 },
                    { weight: 2, name: "BendSW", noExit: 5 },
                    { weight: 2, name: "BendSE", noExit: 7 },
                    { weight: 3, name: "Blocks" },
        ...
        large: {
            normal: {
                rooms: [
                    ...
                    { weight: 2, name: "NSBridge", noExit: 12 },
                    { weight: 2, name: "EWSBridge", noExit: 1 },
                    { weight: 2, name: "EWNBridge", noExit: 3 },
                    { weight: 4, name: "VerticalHole" },
                    { weight: 3, name: "ZHole" },
                    { weight: 3, name: "GoldCorners" },
                    { weight: 3, name: "NorthLedge", noExit: 1 },
                    { weight: 3, name: "SouthLedge", noExit: 3 },
                    { weight: 4, name: "Cross" },
                    { weight: 3, name: "NECorner", noExit: 14 },
                    { weight: 3, name: "NWCorner", noExit: 11 },
                    { weight: 3, name: "SECorner", noExit: 7 },
                    { weight: 3, name: "SWCorner", noExit: 5 },
                    { weight: 4, name: "CornerHoles" },
                    { weight: 2, name: "NSArena", noExit: 12 },
                    { weight: 2, name: "NSDonut", noExit: 12 },
                    { weight: 2, name: "SpikeBridgeEW", noExit: 6 },
                    { weight: 3, name: "NorthGoldPool", noExit: 1 },
                    ...
                    { weight: 2, name: "RollerBridgeEW", noExit: 6 },
                    { weight: 3, name: "Snake" },
        ...
        large: {
            normal: {
                rooms: [
                    ...
                    { weight: 3, name: "CornerNW", noExit: 11 },
                    { weight: 3, name: "CornerNE", noExit: 14 },
                    { weight: 3, name: "CornerSW", noExit: 5 },
                    { weight: 3, name: "CornerSE", noExit: 7 },
                    ...
                    { weight: 3, name: "DeadlyBridge", noExit: 12 },
                    { weight: 3, name: "WiderBridge", noExit: 12 },
                    { weight: 3, name: "NorthHole" },
                    { weight: 3, name: "Bridges" },
                    { weight: 3, name: "ArrowTrap" },
                    { weight: 3, name: "ElaborateTrap" },
                    { weight: 3, name: "NorthEastHole", noExit: 2 },
                    { weight: 3, name: "SouthWestHole", noExit: 4 },
                    { weight: 3, name: "Rainbow", noExit: 3 },
...
function getRooms(zone, floor, flags, seed) {
    ...
    function getRoom(room, previousRoom) {
        ...
        if ((room.chance ?? 1) < 1 && (room.chance < (rand.layout.value))) {
            return null;
        }
        ...
        for (const tag of tags) {
            ...
            if (encounterGroup) {
                const filteredRooms = encounterGroup.filter(current => !seenRooms.includes(current) &&
...
function randomSeed() {
    e$("seed-input").value = (73486680).toString();
    loadSeed();
}
